    ...
    <div className="p-6 max-w-5xl">
      <div className="mb-6">
        <h1 className="text-xl font-semibold">
          {isEcom ? 'Orders & Bookings' : 'Bookings'}
        </h1>
          ...
          {loading ? (
            ...
            <div className="px-5 py-12 text-center">
              ...
              <div className="text-xs text-[#475569] mt-1">
                Bookings made via voice agent appear here automatically.
              </div>
            </div>
          ) : (
            <div className="divide-y divide-[#1E2A3E]">
              {bookings.map((b, i) => (
                <div
                  key={b.id || i}
                  className="grid grid-cols-[1fr_1fr_140px_100px] gap-0 px-5 py-3.5"
                >
                  ...
                  <div className="text-xs font-mono text-[#94A3B8]">
                    {b.slotStart ? formatSlot(b.slotStart) : '—'}
                  </div>
                  <div>
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full ${STATUS_COLORS[b.status] || 'bg-[#1E2A3E] text-[#475569]'}`}
                    >
                      {b.status || 'unknown'}
                    </span>
                  </div>
          ...
          {loading ? (
            ...
            <div className="divide-y divide-[#1E2A3E]">
              {orders.map((o, i) => (
                <div
                  key={o.id || i}
                  className="grid grid-cols-[80px_1fr_1fr_100px_100px] gap-0 px-5 py-3.5"
                >
                  ...
                  <div className="text-sm text-[#94A3B8] truncate pr-2">
                    {o.itemsSummary || '—'}
                  </div>
