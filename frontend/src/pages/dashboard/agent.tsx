      ...
      <div className="flex-1 max-w-3xl">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#475569] mt-0.5">Configure your AI voice agent's personality and tools</p>
          </div>
          <button
            onClick={handleSave}
            disabled={saving}
        ...
        <div className="bg-[#0F1623] border border-[#1E2A3E] rounded-2xl p-6 mb-20 md:mb-0">
          ...
          {activeTab === "personality" && (
            <div className="space-y-5">
              <h2 className="text-sm font-semibold text-[#94A3B8] uppercase tracking-wide">Core Personality</h2>
              ...
              <div>
                <label className="block text-xs font-medium text-[#94A3B8] mb-1.5">Voice Engine</label>
                <select
              ...
              <div>
                ...
                />
                <div className="text-xs text-[#475569] mt-1">This is the first phrase spoken when the call connects. Keep it brief.</div>
              </div>
            </div>
          )}
          ...
          {activeTab === "knowledge" && (
            <div className="space-y-5">
              <h2 className="text-sm font-semibold text-[#94A3B8] uppercase tracking-wide">Knowledge Base</h2>
              <div className="bg-[#080C14] border border-[#1E2A3E] border-dashed rounded-xl p-8 text-center">
                ...
                <p className="text-xs text-[#475569] mb-4">Upload PDFs, menus, or FAQs to train your agent.</p>
                <button className="bg-[#1E2A3E] hover:bg-[#2A3A54] text-white text-xs px-4 py-2 rounded-lg transition-colors">
                  Select Files
                </button>
              </div>
              <div className="space-y-2">
                <div className="text-xs font-medium text-[#94A3B8]">Active Documents</div>
                <div className="text-xs text-[#475569] p-4 border border-[#1E2A3E] rounded-xl bg-[#080C14]">
                  No documents uploaded yet. The agent currently relies on base instructions.
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === "tools" && (
            <div className="space-y-5">
              <h2 className="text-sm font-semibold text-[#94A3B8] uppercase tracking-wide">Tools & Integrations</h2>
              ...
              {tenant.vertical === "ecommerce" && (
                <div className="border border-emerald-500/30 bg-emerald-500/5 rounded-xl p-5 relative overflow-hidden">
                  <div className="absolute top-0 right-0 p-3">
                    <span className="text-[10px] font-bold bg-emerald-500 text-white px-2 py-1 rounded">ACTIVE</span>
                  </div>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-lg bg-[#95BF47] flex items-center justify-center">
                      <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M19.78 6.55A7 7 0 0013.91 4h-3.82L9.4 6c-3 1.87-4.4 3.92-4.4 7a7 7 0 006.1 6.94A7 7 0 0020 13a6.83 6.83 0 00-.22-6.45z" opacity=".2"/><path d="M14.65 3A5.4 5.4 0 0010 5.45c-1.3 1.95-1.5 4.3-1.5 6.05A5.64 5.64 0 0014 17a5.55 5.55 0 005.65-5.5C19.65 6.86 17.5 3 14.65 3z"/></svg>
                    </div>
                    <div>
                      <h3 className="font-semibold text-emerald-500">Shopify Connector</h3>
                      <p className="text-xs text-[#94A3B8]">Enable order tracking & returns via voice.</p>
                    </div>
                  </div>
                  
                  <div className="space-y-3">
                    <div>
                      <label className="block text-xs font-medium text-[#94A3B8] mb-1">Store URL</label>
                      <input
                    ...
                    <div>
                      <label className="block text-xs font-medium text-[#94A3B8] mb-1">Admin API Token</label>
                      <input
                        type="password"
              ...
              {tenant.vertical !== "ecommerce" && (
                <div className="border border-blue-500/30 bg-blue-500/5 rounded-xl p-5 relative overflow-hidden">
                  <div className="absolute top-0 right-0 p-3">
                    <span className="text-[10px] font-bold bg-blue-500 text-white px-2 py-1 rounded">RECOMMENDED</span>
                  </div>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-lg bg-white flex items-center justify-center">
                      <svg className="w-6 h-6 text-blue-500" fill="currentColor" viewBox="0 0 24 24"><path d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zm0-12H5V6h14v2z"/></svg>
                    </div>
                    <div>
                      <h3 className="font-semibold text-blue-400">Google Calendar</h3>
                      <p className="text-xs text-[#94A3B8]">Allow AI to book appointments directly in your calendar.</p>
                    </div>
                  </div>
              ...
              <div className="border border-[#1E2A3E] bg-[#080C14] rounded-xl p-4 flex items-center justify-between opacity-60">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded bg-[#1E2A3E] flex items-center justify-center text-[#94A3B8]">📞</div>
                  <div>
                    <h3 className="text-sm font-medium">Auto-Call Transfer</h3>
                    <p className="text-xs text-[#475569]">Route complex calls to a human.</p>
                  </div>
                </div>
          ...
          {activeTab === "settings" && (
            <div className="space-y-5">
              <h2 className="text-sm font-semibold text-[#94A3B8] uppercase tracking-wide">Business Hours</h2>
              <div className="grid grid-cols-2 gap-4">
                <div>
              ...
              <div className="text-xs text-[#475569] p-4 border border-[#1E2A3E] rounded-xl bg-[#080C14]">
                Outside of these hours, the AI will inform callers that the business is closed, but can still offer to take messages or schedule callbacks for the next day.
              </div>
            </div>
          )}
          ...
          {activeTab === "channels" && (
            <div className="space-y-5">
              <h2 className="text-sm font-semibold text-[#94A3B8] uppercase tracking-wide">Connected Channels</h2>
              ...
              <div className="bg-[#080C14] border border-[#1E2A3E] rounded-2xl p-5 relative overflow-hidden">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[#475569]">{hasRealPhoneNumber ? "Successfully configured" : "Awaiting assignment"}</p>
                    </div>
                  </div>
                  {hasRealPhoneNumber ? (
                    <span className="text-[10px] text-emerald-400 font-bold bg-emerald-500/10 px-2 py-1 rounded">ACTIVE</span>
                  ) : (
                    <span className="text-[10px] text-amber-400 font-bold bg-amber-500/10 px-2 py-1 rounded">PENDING</span>
                  )}
                </div>
                ...
                {hasRealPhoneNumber ? (
                  <div className="bg-[#0F1623] p-3 rounded-xl border border-[#1E2A3E] flex items-center justify-between">
                    <div>
                      <div className="text-[10px] text-[#475569] uppercase tracking-wide">Phone Number</div>
                      <div className="font-mono text-white text-sm">{tenant.phoneNumber}</div>
                    </div>
                    <button className="text-[#94A3B8] hover:text-white transition-colors" title="Copy">
              ...
              <div className="border border-[#1E2A3E] border-dashed rounded-xl p-4 flex items-center justify-center cursor-pointer hover:bg-[#1E2A3E]/30 transition-colors">
                <span className="text-sm font-medium text-blue-400">+ Add new channel (WhatsApp, Web)</span>
              </div>
            </div>
          )}
          ...
          {activeTab === "advanced" && (
            <div className="space-y-5">
              <h2 className="text-sm font-semibold text-[#94A3B8] uppercase tracking-wide">Under The Hood</h2>
              ...
              <div className="bg-[#080C14] border border-[#1E2A3E] rounded-xl p-5">
                <div className="text-xs text-[#475569] mb-3 font-medium flex justify-between">
                  ...
                  <span className="text-xs text-blue-400">Rebuilt on setup</span>
                </div>
              ...
              {hasRealAgent && (
                <div className="bg-[#080C14] border border-[#1E2A3E] rounded-xl p-5 flex items-center justify-between">
                  <div>
                    <div className="text-xs text-[#475569] mb-1 font-medium">ElevenLabs Agent ID</div>
                    <div className="font-mono text-sm text-white">{tenant.agentId}</div>
                  </div>
                  <a
      ...
      <div className="hidden md:block w-80 sticky top-6 self-start shrink-0">
        <div className="bg-[#080C14] border-2 border-[#1E2A3E] rounded-2xl overflow-hidden shadow-2xl flex flex-col h-[500px]">
          <div className="px-5 py-4 bg-[#0F1623] border-b border-[#1E2A3E] flex items-center justify-between shrink-0">
            ...
            <span className="text-[10px] bg-[#1E2A3E] text-[#94A3B8] px-2 py-0.5 rounded font-mono uppercase">Developer UI</span>
          </div>
            ...
            {hasRealAgent ? (
              <div className="w-full z-10 flex flex-col h-full">
                <div className="text-center mb-6 shrink-0">
                  ...
                  <h4 className="text-sm font-medium">Talk to {form.agentName || "Agent"}</h4>
                  <p className="text-xs text-[#475569] mt-1">Interact using your microphone.</p>
                </div>
              ...
              <div className="text-center z-10 px-4">
                ...
                <h4 className="text-sm font-medium mb-1">Testing Unavailable</h4>
                <p className="text-xs text-[#475569] leading-relaxed">
                  You must create your agent first using the blue button on the left to test voice features.
                </p>
              </div>
            )}
          </div>
          <div className="bg-[#05080E] p-3 text-center border-t border-[#1E2A3E]">
            <p className="text-[10px] text-[#475569]">Calls placed here are logged to your dashboard.</p>
          </div>
        </div>
      </div>
